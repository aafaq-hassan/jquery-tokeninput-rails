/*
 * https://github.com/loopj/jquery-tokeninput/pull/257
 *
...
(function ($) {
    ...
    var DEFAULT_SETTINGS = {
        ...
        // tokenValidation is a callback that allows the new token to be validated
        // before being added. If it is not valid (i.e. callback returns false)
        // a message is shown in the dropdown menu bar
        allowedNewItems: false,
        tokenValidation: null,
        invalidTokenText : "You entered an invalid token."
    };
    ...
    $.TokenList = function (input, url_or_data, settings) {
        ...
        function add_token (item) {
            ...
            if($.isFunction(callback)) {
                callback.call(hidden_input, item, focusItem);
            }
        }
        ...
        function delete_token (token) {
            ...
            if($.isFunction(callback)) {
                callback.call(hidden_input, token_data, focusItem);
            }
        }
